                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="bradcaump__inner text-center">
                        	<h2 class="bradcaump-title">Especificaciones</h2>
                            <nav class="bradcaump-content">
                              <a class="breadcrumb_item" href="index.php">Home</a>
                              <span class="brd-separetor">/</span>
                              <span class="breadcrumb_item active">Especificaciones</span>
                            </nav>
                        </div>
                    </div>
                </div>
                        ...
                        <form action="#">               
                            <div class="table-content wnro__table table-responsive">
                                <table>
                                    ...
                                    <tbody>
                                        <tr>
                                            <td class="product-thumbnail"><a href="#"><img src="assetsCliente/images/product/sm-3/1.jpg" alt="product img"></a></td>
