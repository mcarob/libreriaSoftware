...
//$conPu=new ControladorPublicador();
//$publicador=$conPu->devolverPublicador($usuario->getCod_usuario());
        ...
        <div class="wrapper wrapper--w680">
            <div class="card card-4">
                <div class="card-body">
                    ...
                    <input type="hidden" class="form-control" id="cod_usuario" name="cod_usuario" value="">
                    <input type="hidden" class="form-control" id="habilitado" name="habilitado" value="">
                    <input type="hidden" class="form-control" id="cod_cliente" name="cod_cliente" value="<>
                        <label>Nombre</label>
                        <input type="text" class="form-control" id="nom_cliente" name="nom_cliente" placeholder="Nombre" value="">
                        ...
                        <tr>                  
                            ...
                            <td>
                                <div class="form-group">
                                <label>Usuario</label>
                                    <input type="text" class="form-control" id="userName" name="userName" aria-describedby="emailHelp" placeholder="Usuario" value="" readonly>
