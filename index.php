...
<head>        
    ...
    <body>
                            ...
                            <div class="col-md-9">
                                    ...
                                    <div class="row">
                                        <div class="col-sm-6">
                                            <div class="topbar-info">
                                                ...
                                                <a href="mailto:support@libraria.com"><i class="fa fa-envelope"></i>info@laLibreria.com</a>
                                            </div>
                                        </div>
                                        <div class="col-sm-6">
                                            <div class="topbar-links">
                                                <a href="signin.html"><i class="fa fa-lock"></i>Ingresar / Registrar</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="navbar-collapse hidden-sm hidden-xs">
                                    <ul class="nav navbar-nav">
                                        ...
                                        <li class="dropdown">
                                            <a data-toggle="dropdown" class="dropdown-toggle disabled" href="books-media-list-view.html">Documentos Físicos </a>
                                            <ul class="dropdown-menu">
                                                <li><a href="books-media-list-view.html">Libros</a></li>
                                                <li><a href="books-media-gird-view-v1.html">Ponencias</a></li>
                                                <li><a href="books-media-gird-view-v2.html">Artículos Científicos</a></li>
                                            </ul>
                                        </li>
                                        <li class="dropdown">
                                            <a data-toggle="dropdown" class="dropdown-toggle disabled" href="news-events-list-view.html">Documentos OnLine</a>
                                            <ul class="dropdown-menu">
                                                <li><a href="books-media-list-view.html">Libros</a></li>
                                                <li><a href="books-media-gird-view-v1.html">Ponencias</a></li>
                                                <li><a href="books-media-gird-view-v2.html">Artículos Científicos</a></li>
                ...
                <div class="item active">
                    ...
                    <div class="container">
                        <div class="carousel-caption">
                            <h3>Bienvenidos a La Libreria</h3>
                            <h2>Descubre todos los documentos</h2>
                            <p>Tenemos una de las mejores bases de datos con los mejores documentos, tanto nacionales como internacionales</p>
                            <div class="slide-buttons hidden-sm hidden-xs">    
                                <a href="#" class="btn btn-primary">Mas información</a>
                                <a href="#" class="btn btn-default">Reserva Documentos</a>
                            </div>
                        </div>
                    </div>
                </div>
                            ...
                            <ul>
                                <li class="bg-light-green">
                                    <div class="fact-item">
                                        ...
                                        <span>Libros<strong class="fact-counter">45780</strong></span>
                                    </div>
                                </li>
                                <li class="bg-green">
                                    <div class="fact-item">
                                        ...
                                        <span>Ponencias<strong class="fact-counter">32450</strong></span>
                                    </div>
                                </li>
                                <li class="bg-red">
                                    <div class="fact-item">
                                        ...
                                        <span>Artículos<strong class="fact-counter">14450</strong></span>
                                    </div>
                                </li>
                            </ul>
                        </div>
        ...
        <section class="category-filter section-padding">
            <div class="container">
                <div class="center-content">
                    <div class="row">
                        <div class="col-md-6 col-md-offset-3">
                            <h2 class="section-title">Mira las ultimas Incorporaciones</h2>
                ...
                <div class="filter-buttons">
                    <div class="filter btn" data-filter="all">Ultimos Lanzamientos</div>
                    <div class="filter btn" data-filter=".fisicos">Libros Fisicos</div>
                    <div class="filter btn" data-filter=".articulosFisicos">Articulos Físicos</div>
                    <div class="filter btn" data-filter=".ponenciasFisicas">Ponencias Fisicas</div>
                    <div class="filter btn" data-filter=".librosDigitales">Libros Digitales</div>
                    <div class="filter btn" data-filter=".articulosDigitales">Articulos Digitales</div>
                    <div class="filter btn" data-filter=".ponenciasDigitales">Ponencias Digitales</div>
                </div>
            </div>
            <div id="category-filter">
                <ul class="category-list">
                    <li class="category-item fisicos">
                        <figure>
                    ...
                    <li class="category-item articulosFisicos">
                        <figure>
                    ...
                    <li class="category-item ponenciasFisicas">
                        <figure>
                    ...
                    <li class="category-item librosDigitales">
                        <figure>
                    ...
                    <li class="category-item articulosDigitales">
                        <figure>
                    ...
                    <li class="category-item ponenciasDigitales">
                        <figure>
                ...
                <ul>
                    <li class="bg-yellow">
                        <div class="feature-box">
                            ...
                            <a class="yellow" href="#">
                                Ver todos los libros <i class="fa fa-long-arrow-right"></i>
                            </a>
                        </div>
                    </li>
                    <li class="bg-light-green">
        ...
        <section class="social-network section-padding">
            <div class="container">
                <div class="center-content">
                    <h2 class="section-title">Siguenos en nuestras redes sociales</h2>
                    <span class="underline center"></span>
                    <p class="lead"></p>
                </div>
                <ul>
